...
#**Group_Project** : This is a collaboration project done by James Eche and Vivian Iwegbu, students of the ALX Software Engineering program by Holberton school which summarizes the basics  of programming in C. Below is the overview of the project:
...
/root/alx_low_level_programming
```
...
/root/.cargo/bin:/root/local/bin:/root/.rbenv/plugins/ruby-build/bin:/root/.rbenv/shims:/root/.rbenv/bin:/root/.nvm/versions/node/v10.15.3/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin:/root/.cargo/bin:/root/workflow:/root/.local/bin
```
...
* **James Eche** **||** [Github](https://github.com/James0711) **|** [email](jengreat94@gmail.com)  
* **Vivian Iwegbu** **||** [Github](https://github.com/vivjoe) **|** [email]( vivianiwegbu@gmail.com)
